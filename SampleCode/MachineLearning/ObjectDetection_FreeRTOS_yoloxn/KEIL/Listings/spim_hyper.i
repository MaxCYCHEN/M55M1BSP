...
# 43 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_SetDLLDelayNum(SPIM_T *spim, uint32_t u32DelayNum)
{
    volatile int i32Timeout = 0xFFFF;
    uint32_t u32Div = 0;
    ...
    (((SPIM_T *) ((((uint32_t) 0x40000000UL) + 0x00040000UL) + 0x02000UL))->DLL0 = (((SPIM_T *) ((((uint32_t) 0x40000000UL) + 0x00040000UL) + 0x02000UL))->DLL0 & ~((0x1ul << (0)))) | (((0x01UL)) << (0)));
    (((SPIM_T *) ((((uint32_t) 0x40000000UL) + 0x00040000UL) + 0x03000UL))->DLL0 = (((SPIM_T *) ((((uint32_t) 0x40000000UL) + 0x00040000UL) + 0x03000UL))->DLL0 & ~((0x1ul << (0)))) | (((0x01UL)) << (0)));



    (((SPIM_T *) ((((uint32_t) 0x40000000UL) + 0x00040000UL) + 0x02000UL))->DLL0 = (((SPIM_T *) ((((uint32_t) 0x40000000UL) + 0x00040000UL) + 0x02000UL))->DLL0 & ~((0x1ul << (1)))) | (((0x01UL)) << (1)));
    (((SPIM_T *) ((((uint32_t) 0x40000000UL) + 0x00040000UL) + 0x03000UL))->DLL0 = (((SPIM_T *) ((((uint32_t) 0x40000000UL) + 0x00040000UL) + 0x03000UL))->DLL0 & ~((0x1ul << (1)))) | (((0x01UL)) << (1)));

    u32Div = ((spim->CTL1 & (0xfffful << (16))) >> (16));
    ...
    (spim->DLL0 = (spim->DLL0 & ~((0x3ul << (20)))) | ((u32Div) << (20)));
...
# 138 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_WaitSPIMENDone(SPIM_T *spim, uint32_t u32IsSync)
{
    volatile int32_t i32TimeOutCount = 0xFFFF;

    (spim->CTL1 |= (0x1ul << (0)));

    if (u32IsSync)
    {
        if (((spim->HYPER_INTEN & (0x1ul << (0))) >> (0)))
        {
            while (((spim->HYPER_INTEN & (0x1ul << (0))) >> (0)))
            {
...
# 178 "../../../../Library/StdDriver/src/spim_hyper.c"
static int32_t SPIM_HYPER_IsCMDIdle(SPIM_T *spim)
{
    volatile int32_t i32TimeOutCnt = 0xFFFF;
...
void SPIM_HYPER_Init(SPIM_T *spim, uint32_t u32Div)
{
    ...
    (spim->CTL1 = (spim->CTL1 & ~((0xfffful << (16)))) | ((u32Div) << (16)));
}
# 215 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Reset(SPIM_T *spim)
{
    spim->HYPER_CMD = (0x00000001);

    if (SPIM_HYPER_IsCMDIdle(spim) != ( 0L))
    {
        return (-2L);
    }
...
# 234 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_ExitHSAndDPD(SPIM_T *spim)
{
...
# 259 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_ReadHyperRAMReg(SPIM_T *spim, uint32_t u32Addr)
{
...
# 295 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_WriteHyperRAMReg(SPIM_T *spim, uint32_t u32Addr, uint32_t u32Value)
{
    if ((u32Addr != (0x00000000)) &&
            (u32Addr != (0x00000002)) &
...
# 327 "../../../../Library/StdDriver/src/spim_hyper.c"
int16_t SPIM_HYPER_Read1Word(SPIM_T *spim, uint32_t u32Addr)
{
    spim->HYPER_ADR = u32Addr;
...
# 370 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Write1Byte(SPIM_T *spim, uint32_t u32Addr, uint8_t u8Data)
{
    (spim->HYPER_WDATA &= ~(0xFFFFFFFF));
...
# 396 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Write2Byte(SPIM_T *spim, uint32_t u32Addr, uint16_t u16Data)
{
    (spim->HYPER_WDATA &= ~(0xFFFFFFFF));
...
# 422 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Write3Byte(SPIM_T *spim, uint32_t u32Addr, uint32_t u32Data)
{
    (spim->HYPER_WDATA &= ~(0xFFFFFFFF));
...
# 448 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Write4Byte(SPIM_T *spim, uint32_t u32Addr, uint32_t u32Data)
{
    (spim->HYPER_WDATA &= ~(0xFFFFFFFF));
...
# 475 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_DMAWrite(SPIM_T *spim, uint32_t u32Addr, uint8_t *pu8WrBuf, uint32_t u32NTx)
{
    if (pu8WrBuf == 0)
    {
    ...
    (spim->CTL0 = (spim->CTL0 & ~((0x3ul << (22)))) | (((1UL)) << (22)));

    spim->SRAMADDR = (uint32_t) pu8WrBuf;
    spim->DMACNT = u32NTx;
    spim->FADDR = u32Addr;

    if (SPIM_HYPER_WaitSPIMENDone(spim, (0x01UL)) != ( 0L))
    {
        return (-2L);
    }
...
# 530 "../../../../Library/StdDriver/src/spim_hyper.c"
void SPIM_HYPER_EnterDirectMapMode(SPIM_T *spim)
{
    (spim->CTL0 = (spim->CTL0 & ~((0x3ul << (22)))) | (((3UL)) << (22)));
}
...
void SPIM_HYPER_ExitDirectMapMode(SPIM_T *spim)
{
    (spim->CTL0 = (spim->CTL0 & ~((0x3ul << (22)))) | (((0UL)) << (22)));
}
# 553 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_IsDMMDone(SPIM_T *spim)
{
    volatile int32_t u32TimeOutCount = 0xFFFF;

    (spim->DMMCTL |= (0x1ul << (27)));
