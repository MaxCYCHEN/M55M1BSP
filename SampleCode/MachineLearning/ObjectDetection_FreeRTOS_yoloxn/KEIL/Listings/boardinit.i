...
# 199 "../../../../Library/CMSIS/Core/Include\\core_cm55.h" 3
 extern "C" {
...
# 232 "../../../../Library/Device/Nuvoton/M55M1/Include/ks_reg.h"
    ...
    volatile uint32_t RESERVE0[1005];
    volatile uint32_t VERSION;
...
# 397 "../../../../Library/Device/Nuvoton/M55M1/Include/lpadc_reg.h"
    ...
    volatile uint32_t RESERVE6[502];
...
# 731 "../../../../Library/Device/Nuvoton/M55M1/Include/lpuart_reg.h"
    ...
    volatile uint32_t AUTOCTL;
    volatile uint32_t AUTOSTS;
    volatile uint32_t RESERVE3[999];
    volatile uint32_t VERSION;
...
# 2267 "../../../../Library/Device/Nuvoton/M55M1/Include/scu_reg.h"
    ...
    volatile uint32_t RESERVE12[15];
    union
    {
        volatile uint32_t PMVA[64];
        struct
        {
            ...
            volatile uint32_t RESERVE15[15];
            ...
            volatile uint32_t SPIM1MVA;
            volatile uint32_t RESERVE17[14];
        };
    };
    union
    {
    ...
    volatile uint32_t SPIM1MPCLUT[8];
} SCU_T;
...
# 2931 "../../../../Library/Device/Nuvoton/M55M1/Include/sys_reg.h"
    ...
    volatile uint32_t RESERVE11[88];
...
# 881 "../../../../Library/Device/Nuvoton/M55M1/Include/uart_reg.h"
    ...
    volatile uint32_t DWKCOMP;
    volatile uint32_t RS485DD;
    volatile uint32_t RESERVE0[1003];
    volatile uint32_t VERSION;
...
# 639 "../../../../Library/Device/Nuvoton/M55M1/Include/usbd_reg.h"
    ...
    volatile uint32_t RESERVE2[283];
...
# 447 "../../../../Library/StdDriver/inc\\canfd.h"
}
...
# 1101 "../../../../Library/StdDriver/inc\\clk.h"
}
...
# 276 "../../../../Library/StdDriver/inc\\dac.h"
}
...
# 719 "../../../../Library/StdDriver/inc\\eadc.h"
}
...
# 412 "../../../../Library/StdDriver/inc\\fmc.h"
}
...
extern "C"
{
# 255 "../../../../Library/StdDriver/inc\\hsotg.h"
}
...
# 410 "../../../../Library/StdDriver/inc\\hsusbd.h"
}
...
extern "C"
{
# 243 "../../../../Library/StdDriver/inc\\otg.h"
}
...
# 591 "../../../../Library/StdDriver/inc\\uart.h"
}
...
# 363 "../../../../Library/StdDriver/inc\\utcpd.h"
}
...
# 824 "../../../../Library/StdDriver/inc\\usbd.h"
}
...
static void SYS_Init(void)
{
    ...
    CLK_SetBusClock((0x4UL << (0)), 0x00000001UL, 180000000UL);
    ...
    HyperRAM_PinConfig(((SPIM_T *) ((((uint32_t) 0x40000000UL) + 0x00040000UL) + 0x03000UL)));
}
...
int BoardInit(void)
{
    ...
    HyperRAM_Init(((SPIM_T *) ((((uint32_t) 0x40000000UL) + 0x00040000UL) + 0x03000UL)));

    SPIM_HYPER_EnterDirectMapMode(((SPIM_T *) ((((uint32_t) 0x40000000UL) + 0x00040000UL) + 0x03000UL)));
