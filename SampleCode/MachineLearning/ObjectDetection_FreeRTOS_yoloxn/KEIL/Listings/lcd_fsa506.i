...
static void fsa506_write_reg(uint16_t reg, uint16_t data)
{
    ...
    (*((volatile uint32_t *)((((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29800UL)+(0x40*(7))) + ((7)<<2)))) = 0;
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (reg & 0xFF));
    __builtin_arm_dsb(0xF);
    (*((volatile uint32_t *)((((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29800UL)+(0x40*(7))) + ((7)<<2)))) = 1;


    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (data & 0xFF));
    __builtin_arm_dsb(0xF);


    (*((volatile uint32_t *)((((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29800UL)+(0x40*(7))) + ((7)<<2)))) = 0;
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0x80));
    __builtin_arm_dsb(0xF);
    (*((volatile uint32_t *)((((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29800UL)+(0x40*(7))) + ((7)<<2)))) = 1;
}
...
static void fsa506_send_pixels(uint16_t *pixels, uint32_t fixed_color, int32_t byte_len)
{
    ...
    (*((volatile uint32_t *)((((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29800UL)+(0x40*(7))) + ((7)<<2)))) = 0;
    (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (0xC1));
    __builtin_arm_dsb(0xF);
    (*((volatile uint32_t *)((((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29800UL)+(0x40*(7))) + ((7)<<2)))) = 1;
# 69 "../Device/Display/LCD/LCD_FSA506.c"
    {
        ...
        {
            if (pixels)
                (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (pixels[i]));
            else
                (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (fixed_color));
...
void fsa506_put_char8x16(uint16_t x, uint16_t y, uint8_t c, uint32_t fColor, uint32_t bColor)
{
    ...
    for (i = 0; i < 16; i++)
    {
        ...
        for (j = 0; j < 8; j++)
        {
            if ((m & 0x80) == 0x80)
            {
                (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (fColor));
            }
            else
            {
                (*((volatile uint16_t *)((0x60000000UL +(0UL*0x00100000UL))+(0x0))) = (bColor));
            }
...
static int32_t fsa506_init(void)
{
    ...
    fsa506_write_reg(0x40, 0x12);
    fsa506_write_reg(0x41, 0x05);
    fsa506_write_reg(0x42, 0x06);


    fsa506_write_reg(0x08, (g_s_WQVGA_FSA506.m_u16Width >> 8));
    fsa506_write_reg(0x09, (g_s_WQVGA_FSA506.m_u16Width));


    fsa506_write_reg(0x0a, 0x00);
    fsa506_write_reg(0x0b, 0x00);
    fsa506_write_reg(0x0c, 0x00);


    fsa506_write_reg(0x10, 0x0D);
    fsa506_write_reg(0x11, 0x05);


    fsa506_write_reg(0x12, 0x00);
    fsa506_write_reg(0x13, 0x00);
    fsa506_write_reg(0x14, (41 >> 8));
    fsa506_write_reg(0x15, (41));

    fsa506_write_reg(0x16, (43 >> 8));
    fsa506_write_reg(0x17, (43));
    fsa506_write_reg(0x18, (g_s_WQVGA_FSA506.m_u16Width >> 8));
    fsa506_write_reg(0x19, (g_s_WQVGA_FSA506.m_u16Width));
    fsa506_write_reg(0x1a, (525 >> 8));
    fsa506_write_reg(0x1b, (525));
    fsa506_write_reg(0x1c, 0x00);
    fsa506_write_reg(0x1d, 0x00);
    fsa506_write_reg(0x1e, (10 >> 8));
    fsa506_write_reg(0x1f, (10));
    fsa506_write_reg(0x20, (12 >> 8));
    fsa506_write_reg(0x21, (12));
    fsa506_write_reg(0x22, (g_s_WQVGA_FSA506.m_u16Height >> 8));
    fsa506_write_reg(0x23, (g_s_WQVGA_FSA506.m_u16Height));
    fsa506_write_reg(0x24, (286 >> 8));
    fsa506_write_reg(0x25, (286));

    fsa506_write_reg(0x26, 0x00);
    fsa506_write_reg(0x27, 0x00);
    fsa506_write_reg(0x28, 0x00);
    fsa506_write_reg(0x29, 0x01);
    ...
    fsa506_write_reg(0x30, 0x00);
    fsa506_write_reg(0x31, 0x00);
    fsa506_write_reg(0x32, 0x00);
    fsa506_write_reg(0x33, 0x00);
    fsa506_write_reg(0x34, (g_s_WQVGA_FSA506.m_u16Width >> 8));
    fsa506_write_reg(0x35, (g_s_WQVGA_FSA506.m_u16Width));
    fsa506_write_reg(0x36, ((2 * g_s_WQVGA_FSA506.m_u16Height) >> 8));
    fsa506_write_reg(0x37, (2 * g_s_WQVGA_FSA506.m_u16Height));
