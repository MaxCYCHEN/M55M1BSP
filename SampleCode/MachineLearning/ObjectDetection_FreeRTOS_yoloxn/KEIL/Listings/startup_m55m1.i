...
# 19 "C:\\Keil_v5\\ARM\\ARMCLANG\\Bin\\..\\include\\inttypes.h" 3
...
# 20 "C:\\Keil_v5\\ARM\\ARMCLANG\\Bin\\..\\include\\inttypes.h" 2 3
...
__attribute__((__noreturn__)) void Reset_Handler_Main(void);
...
# 198 "../../../../Library/Device/Nuvoton/M55M1/Source/startup_M55M1.c"
const VECTOR_TABLE_Type __Vectors[] __attribute__((used, section("RESET"))) =
# 214 "../../../../Library/Device/Nuvoton/M55M1/Source/startup_M55M1.c"
{
...
__attribute__((__noreturn__)) void Reset_Handler_Main(void)
{
    if ((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) == 0)
    {
        ...
        if (!(((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->RSTSTS & (0x1ul << (0))))
        {
            SYS_ResetChip();
        }
        ...
        if (((PMC_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x02000UL))->SYSRB0PC != 0)
        {
            ((PMC_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x02000UL))->SYSRB0PC = 0;

            while (((PMC_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x02000UL))->SYSRB0PC & (0x1ul << (31)))
                ;
        }


        ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SRAMCTL |= (0x1ul << (0));
        ...
        if (((PMC_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x02000UL))->SYSRB1PC != 0)
        {
            ...
            while (((PMC_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x02000UL))->SYSRB1PC & (0x1ul << (31)))
                ;
        }


        ((CLK_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x01000UL))->SRAMCTL |= (0x1ul << (1));
    }
    ...
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->CPACR |= ((3U << 10U * 2U) |
                   (3U << 11U * 2U));
# 501 "../../../../Library/Device/Nuvoton/M55M1/Source/startup_M55M1.c"
