...
# 14 "../Device/Display/LCD.h" 2
# 40 "../Device/Display/LCD.h"
...
static void Configure_EBI_16BIT_Pins(void)
{
    ...
    ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPC_MFP0 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPC_MFP0 & (~(0x1ful << (0)))) | (0x2UL<<(0)));
    ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPC_MFP0 = ((((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPC_MFP0 & (~(0x1ful << (8)))) | (0x2UL<<(8)));
...
int Display_Init(void)
{
    ...
    GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29080UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x29080UL))), ((0x00000001UL) | (0x00000002UL) | (0x00000004UL) | (0x00000008UL) | (0x00000010UL) | (0x00000020UL)), 0x1UL);
    ...
    GPIO_SetSlewCtl(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL))), ((0x00000100UL) | (0x00000200UL) | (0x00000400UL) | (0x00000800UL)), 0x1UL);
    ...
    GPIO_SetMode(((__extension__({ register unsigned int current_pc; __asm volatile("mov %0, pc" : "=r"(current_pc) : : ); current_pc; }) & ((uint32_t) 0x10000000UL)) ? ((GPIO_T *) (((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL) + ((uint32_t) 0x10000000UL))) : ((GPIO_T *) ((((uint32_t) 0x40000000UL) + 0x00200000UL) + 0x291C0UL))), 1 << 7, 0x1UL);
...
void Display_ClearRect(uint32_t u32Color, const S_DISP_RECT *psRect)
{
    ...
    s_psLCD->m_pfnSetColumn(psRect->u32TopLeftX, psRect->u32BottonRightX);
    s_psLCD->m_pfnSetPage(psRect->u32TopLeftY, psRect->u32BottonRightY);
    s_psLCD->m_pfnSentPixel(0, u32Color, h * w * sizeof(uint16_t));
}
